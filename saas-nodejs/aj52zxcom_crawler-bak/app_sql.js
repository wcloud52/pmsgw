let sqltext = {
    ...
    queryCrawlerDetail: [
        'SELECT detail_id,master_id,master_type,master_website,cote_id,cote_name,cote_state,master_text,master_href,detail_state,detail_crawler_page,detail_crawler_href,create_time,modify_time FROM nodejs_crawler_detail',
        'WHERE detail_state=\'0\' and cote_state=? ORDER BY master_id,detail_crawler_page'
    ].join(' '),
