        ...
        .end(function(err, sres) {
            ...
            bigfileSet.forEach(function(element) {
                ...
                testUrl(urlPath).then(function(text) {
                    ...
                    if (Data_num == 0)
                        Data_num = 10000;
                    updateCrawlerMasterWith(master_id, master_type, master_website, cote_id, cote_name, master_text, master_href, JSON.stringify(bigfileSet), Data_num, urlPath);
                    master_id = "-1";
                }, function(text) {
...
router.get('/detail', function(req, res, next) {
    ...
    connection.query(app_sql.queryCrawlerDetail, [cote_state],
        function(results, fields) {
            //console.log("queryCrawlerDetail-> : " + JSON.stringify(results));
