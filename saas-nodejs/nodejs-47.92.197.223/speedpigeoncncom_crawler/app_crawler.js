    ...
    superagent.get('http://speed.pigeoncn.com/sszb4.html')
        .end(function(err, sres) {
            ...
            $('.sszbn #xh li a').each(function(idx, element) {
                ...
                if (cut == scut) {
                    var cote_id = $element.attr('href').match(/imfor_(\S*)_/)[1];
        ...
        .end(function(err, sres) {
            ...
            bigfileSet.forEach(function(element) {
                ...
                testUrl(urlPath).then(function(text) {
                    ...
                    updateCrawlerMasterWith(master_id, master_type, master_website, cote_id, cote_name, master_text, master_href, JSON.stringify(bigfileSet), sandbox.race.Data_num, urlPath);
                    master_id = "-1";
                }, function(text) {
    ...
    connection.query(app_sql.queryCrawlerDetail, [],
        function(results, fields) {
            ...
            results.forEach(function(element) {
                crawlerDetail(element.detail_id, element.master_id, element.master_type, element.master_website, element.master_href, element.cote_id, element.cote_name, element.master_text, element.detail_crawler_href);
            });
            res.send(rrtt);
        }
    );
...
function crawlerDetail(detail_id, master_id, master_type, master_website, master_href, cote_id, cote_name, master_text, detail_crawler_href) {
        ...
        .end(function(err, sres) {
            try {
                ...
                json.data.forEach(function(element) {
                    ...
                    var rt = [detail_id2, master_id, master_type, master_website, master_href, cote_id, cote_name, master_text, pageid, ii, '0', element.distence, element.ringnum, element.pigowner, element.cometime, element.cotenum, element.speed, rank, new Date(), new Date()];
                ...
                updateCrawlerDetail(detail_state, detail_josn, detail_crawler_href);
