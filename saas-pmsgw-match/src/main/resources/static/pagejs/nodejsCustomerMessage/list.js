...
layui.use([ 'element', 'laydate', 'table', 'form', 'fuzzyQuery' ], function() {
	...
	baseOperation.initTable("listTable", "/nodejsCustomerMessage/list", {
	...
	function flashTable() {
		...
		var search_game_pigowner = $("#search_game_pigowner").val();
		if (search_game_pigowner.length > 0)
			fuzzyQuery.addLike("game_pigowner", search_game_pigowner);
