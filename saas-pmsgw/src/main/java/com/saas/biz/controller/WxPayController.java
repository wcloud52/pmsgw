 ...
 * 
 {
  "appid": "wx6fe226626254fab1",
  "mchBillNo": "1234567",
  "mchId": "1498533382",
  "sendName": "大众赛鸽",
  "reOpenid": "ocSsDwjRXUH_Kn2hCZQN47z6YpnM",
  "totalAmount": 100,
  "signType":"MD5",
  "totalNum": 1,
  "wishing": "恭喜发财" ,
  "clientIp": "36.110.19.90",
  "actName": "测试",
  "remark": "测试",
  "wxAppid": "wx6fe226626254fab1"
}
 * */
  /**
   * <pre>
  ...
  public <T> WxPayNativeOrderResult createOrderTest() throws WxPayException {
	  WxPayUnifiedOrderRequest orderRequest = new WxPayUnifiedOrderRequest();
      orderRequest.setOutTradeNo(UUID.randomUUID().toString().substring(0, 8));
      orderRequest.setProductId("1122");
      //orderRequest.setOpenid("ocSsDwjRXUH_Kn2hCZQN47z6YpnM");
      // TODO 更有意义的显示名称
      orderRequest.setBody("Tuan-Mall商场-订单支付");
      // 元转成分
      Integer fee = 1;
      // 这里演示仅支付1分
      // 实际项目取消下面两行注释
      //BigDecimal actualPrice = new BigDecimal(1);
      //fee = actualPrice.multiply(new BigDecimal(100)).intValue();
      orderRequest.setTotalFee(fee);
      // TODO 用户IP地址
      orderRequest.setSpbillCreateIp("36.110.19.90");
      orderRequest.setNotifyUrl("test");
  ...
  public byte[] getQrcode()
          throws WriterException, IOException, WxPayException{
	  WxPayNativeOrderResult result=createOrderTest();
	  String url=result.getCodeUrl();
	  System.out.println(url);
      return getResponseEntity(url, 200, 200, "png");
  }
  /**
   * 生成并下载二维码
   * @param url 二维码对于URL
   ...
   * @throws IOException
   */
  public  byte[] getResponseEntity(String url,int width, int height,String format) throws WriterException, IOException {
