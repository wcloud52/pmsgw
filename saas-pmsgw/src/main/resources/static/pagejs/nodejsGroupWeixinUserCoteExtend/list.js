...
layui.use([ 'element', 'laydate', 'table', 'form', 'fuzzyQuery' ], function() {
	...
	selectCote();
	baseOperation.initTable("listTable", "/nodejsGroupWeixinUserCoteExtend/list", {
		field : 'cote_name',
		type : 'asc'
	...
	$('#btnSendMessage').on(
			...
			function() {
				...
				if (data != null && data.length > 0) {
					var jsonData = data;
					var url = '/nodejsGroupWeixinUserCoteExtend/edit.html';
					var opUrl = "/nodejsGroupWeixinUserCoteExtend/sendMessage";
