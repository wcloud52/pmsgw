    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border style="width: 100%" height="300">
                ...
                <el-table-column prop="name" label="鸽主名称" width="100" fixed>
                </el-table-column>
                <el-table-column prop="footer" label="足环号" width="100" fixed>
                </el-table-column>
                 <el-table-column prop="time" label="上传时间" width="100" fixed>
                </el-table-column>
                 <el-table-column prop="group" label="分组情况" width="100" fixed>
                </el-table-column>
                 <el-table-column prop="grouper" label="分组人">
                </el-table-column>
                <el-table-column prop="grouptime" label="分组时间">
                </el-table-column>
                <el-table-column prop="groupend" label="分组结束时间">
                </el-table-column>
        ...
        <el-dialog title="分组" :visible.sync="groupVisible" width="84%">
            ...
            <el-tabs v-model="activeName" @tab-click="handleTabClick">
                ...
                <el-tab-pane label="未匹配" name="unmatched">
                    <el-row :gutter="20">
                        <el-col :span="6" :offset="18">
                            <el-input v-model="unmatched_schfilter" placeholder="搜索"></el-input>
                        </el-col>
                    </el-row>
                    <el-table :data="unmatched_groupTables" :span-method="unmatchedMerge" border style="width: 100%;">
                        <el-table-column prop="number" label="鸽主编号" width="180"></el-table-column>
                        <el-table-column prop="name" label="鸽主名称"></el-table-column>
                        <el-table-column prop="originCount" label="原始交鸽数"></el-table-column>
                        <el-table-column prop="footerRing" label="赛鸽足环"></el-table-column>
    ...
    export default {
        ...
        computed: {
            notGrouped_groupTables:function() {
              ...
              unmatched_groupTables:function() {
                var schfilter = this.unmatched_schfilter;
                if (schfilter) {
                    return  this.unmatched_groupTabData.filter( function(item) {
                        return Object.keys(item).some( function(key) {
                            return String(item[key]).toLowerCase().indexOf(schfilter) > -1;
                        })
                    })
                }
                return this.unmatched_groupTabData;
              }
        },
        watch: {
        ...
        mounted(){
            ...
            this.mountedMerge(this.unmatched_groupTabData, this.spanArr.unmatched, this.pos.unmatched)
        },
        methods: {
            // mounted() 中通用的方法 合并表格
            ...
            unmatchedMerge({ row, column, rowIndex, columnIndex }) {
                if (columnIndex < 3) {
                    if (this.spanArr.unmatched[rowIndex]) {
                        return {
                            rowspan:this.spanArr.unmatched[rowIndex],
                            colspan:1
                        }
                    } else {
                        return {
