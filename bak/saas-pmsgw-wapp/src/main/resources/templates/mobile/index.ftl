...
<body>
	...
	<div class="withdrawals-panel"><div class="groupby-info-panle"><h3><a href="/pmsgw-weixin-app/wapIndex/detail">商都龙轩500公里决赛</a></h3><p>司放时间：<span class="am-text-success">2016/10/28 7:15:03</span>   司放地点：<span class="am-text-success">西乌旗</span></p><p>集鸽羽数：<span class="am-text-success">/</span>   司放天气：<span class="am-text-success">晴</span></p><p>司放地坐标：<span class="am-text-success">118.12/ 44.30</span>   参考空距：<span class="am-text-success">498.28</span></p><p>当前归巢：<span class="am-text-success">/</span></p><p>比赛状态:<span class="am-text-success">比赛中</span></p></div></div>
	<div class="withdrawals-panel"><div class="groupby-info-panle"><h3><a href="/pmsgw-weixin-app/wapIndex/detail">商都龙轩500公里决赛</a></h3><p>司放时间：<span class="am-text-success">2016/10/28 7:15:03</span>   司放地点：<span class="am-text-success">西乌旗</span></p><p>集鸽羽数：<span class="am-text-success">/</span>   司放天气：<span class="am-text-success">晴</span></p><p>司放地坐标：<span class="am-text-success">118.12/ 44.30</span>   参考空距：<span class="am-text-success">498.28</span></p><p>当前归巢：<span class="am-text-success">/</span></p><p>比赛状态:<span class="am-text-success">比赛中</span></p></div></div>
	</div>
	<div data-am-widget="list_news" class="am-list-news am-list-news-default">
	...
	<div data-am-widget="navbar" class="am-navbar am-cf am-navbar-default " id="">
		<ul class="am-navbar-nav am-cf am-avg-sm-4">
			<li><a href="tel:123456789"> <span class="am-icon-phone"></span> <span class="am-navbar-label">公棚直播</span>
			</a></li>
			<li data-am-navbar-share><a href="###"> <span class="am-icon-share-square-o"></span> <span class="am-navbar-label">训放直播</span>
			</a></li>
			<li data-am-navbar-qrcode><a href="###"> <span class="am-icon-qrcode"></span> <span class="am-navbar-label">赛季中心</span>
			</a></li>
			<li><a href="https://github.com/allmobilize/amazeui"> <span class="am-icon-github"></span> <span class="am-navbar-label">个人中心</span>
			</a></li>
...
<%-- 	<script src="${ctx}/js/easybcp/plugins/extend/jquery-ui-1.10.3.custom.min.js" type="text/javascript"></script>
	<script src="${ctx}/js/easybcp/plugins/extend/bootstrap.min.js" type="text/javascript"></script>
	<script src="${ctx}/js/easybcp/plugins/extend/jquery-migrate-1.2.1.min.js" type="text/javascript"></script>

	<script src="${ctx}/js/easybcp/plugins/jquery.dataTables.js" type="text/javascript"></script>
	<script src="${ctx}/js/easybcp/plugins/dataTables_bootstrap.js" type="text/javascript"></script>
	<script src="${ctx}/js/easybcp/plugins/TableTools.js" type="text/javascript"></script> --%>
	<script>
		$(function() {
			var oTableTools = {
					//"sRowSelect" : "single",
			...
			$('#tableList').dataTable({
				...
				"fnRowCallback" : function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
					...
					v += '<h3><a href="../plugins/wapIndex/detail">商都龙轩500公里决赛</a></h3>';
