...
layui.define(['layer', 'laypage', 'laytpl'], function (exports) {
    ...
    Paging.prototype.init = function (options) {
        ...
        that.get({
            ...
            fuzzyQuery:options.params.json.fuzzyQuery,
            sort:_config.pageConfig.sort
        });
    ...
    Paging.prototype.get = function (options) {
       ...
       _config.params.json.fuzzyQuery=options.fuzzyQuery;
        _config.params.json.pageIndex=options.pageIndex;
        _config.params.json.pageSize=options.pageSize;
        ...
        $.ajax({
            ...
            success: function (json, status, xhr) {
                ...
                if (json.code==0) {
                    ...
                    $(_config.elem).html('<tr><td colspan="' + thLength + '" style="text-align:left;">' + result.message + '</td></tr>');
                    if (_config.fail) {
