		...
		<div class="content-search">
			<form class="layui-form layui-form-pane" action="">
				<div class="layui-inline">
					<label class="layui-form-label">第三方名称</label>
					<div class="layui-input-block">
						<input  autocomplete="off" placeholder="请输入第三方名称" class="layui-input" type="text"/>
					</div>
				</div>	
				<div class="layui-inline">
					<label class="layui-form-label">联系人</label>
					<div class="layui-input-block">
						<input  autocomplete="off" placeholder="请输入联系人" class="layui-input" type="text"/>
					</div>
				</div>		
				<div class="layui-inline">
					<label class="layui-form-label">手机号码</label>
					<div class="layui-input-block">
						<input  autocomplete="off" placeholder="请输入手机号码" class="layui-input" type="text"/>
					</div>
				</div>		
				<div class="layui-inline">
			...
			<table class="layui-table" lay-skin="nob">
			  <tbody>
			    <tr>
			      ...
			      <td>成交AGR：1200000 <span class="f12">（<span class="price">1200000.00</span>）</span></td>
			    </tr>
			  </tbody>
			</table>
		  </div>
			...
			<table class="layui-table" lay-skin="line">
			  ...
			  <tbody>
			    <tr>
			    	...
			    	<td>100000<span class="f12">（<span class="price">1200000.00</span>）</span></td>
			    	<td><span class="price">100000.00</span></td>
			    </tr>
