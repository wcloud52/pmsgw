...
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        }).addPathPatterns("/index.html","/main.html").excludePathPatterns("/login.html","/swagger-ui.html");
     // kisso 拦截器配置
       registry.addInterceptor(new SSOSpringInterceptor()).addPathPatterns("/**").
       excludePathPatterns("/wap/**","/wapIndex/**","/waplogin/**","/weixinuser/**",
    		   "/wx/auth/**","/wappPigowner/**","/086019com/**","/ybsxacom/**","/yunfeichinacom/**"
