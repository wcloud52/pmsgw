...
import com.ifp.weixin.entity.message.resp.BaseMessage;
...
import com.ifp.weixin.entity.message.resp.VideoMessage;
...
public class MessageService {
	...
	public static String bulidSendMessage(Object obj, String msgType) {
		...
		// 图文消息处理
		if (msgType == ConstantWeixin.RESP_MESSAGE_TYPE_NEWS) {
