...
public class UserService {
	...
	public static String GET_USER_INFO2 = "https://api.weixin.qq.com/sns/userinfo?access_token=ACCESS_TOKEN&openid=OPENID&lang=zh_CN";

	public static UserWeiXin getUserInfo2(String appid, String appsecret,String code) {
		AccessToken accessToken = WeixinUtil.getAccessToken2(appid,appsecret,code);
		String openid=accessToken.getOpenid();
		String token=accessToken.getToken();
		UserWeiXin user = null;

		if (token != null) {
			String url = GET_USER_INFO2.replace("ACCESS_TOKEN", token).replace(
					"OPENID", openid);
	 ...
	 */
	public static UserWeiXin getUserInfo(String appid, String appsecret) {
