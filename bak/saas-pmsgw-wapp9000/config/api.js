...
// 云平台上线时使用
//var StorageApi = 'https://wapp9100.sdwl18.com/os/storage/create';
...
module.exports = {
  ...
  IndexUrl2: WxApiRoot2 + 'home/index', //首页数据接口
  PigownerList: WxApiRoot2 + 'wappPigowner/list',  //收货地址列表
  PigownerDetail: WxApiRoot2 + 'wappPigowner/one',  //收货地址详情
  PigownerSave: WxApiRoot2 + 'wappPigowner/save',  //保存收货地址
  PigownerDelete: WxApiRoot2 + 'wappPigowner/delete',  //保存收货地址
